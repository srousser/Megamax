...
public class VirtualBoard {
    ...
    public VirtualBoard(int rows, int cols, int winLength, Player player1, Player player2, Player player,
                        int slot, int branch_depth, int[][] pieces) {
        this.rows = rows;
        this.cols = cols;
    ...
    public int move() {
        boolean placed = place(slot, player);
        if (placed) {
            if(checkForWinner()){
                return branch_score;
            }
